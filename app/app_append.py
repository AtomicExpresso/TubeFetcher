...
class AppAppend:
    ...
    def append_progress_widgets(self) -> None:
        self.parent.frames.progress_frame.grid(
    ...
    def append_top_widgets(self) -> None:
        ...
        self.parent.widgets.input.grid(
            column=0, columnspan=3, row=0, pady=10, padx=(20, 90), sticky="ew"
        )
        self.parent.widgets.addvideo_btn.grid(
            column=1, row=0, pady=10, padx=(0, 0), sticky="e"
        )
        self.parent.widgets.settings_btn.grid(
            column=2, row=0, pady=10, padx=(20, 20), sticky="e"
        )

    # append bottom frame widgets
    def append_bottom_widgets(self) -> None:
        self.parent.frames.bottom_frame.grid(
            row=3, column=0, columnspan=3, sticky="nsew"
        )
        self.parent.widgets.folder_btn.grid(
            column=0, row=0, pady=10, padx=(20, 10), sticky="w"
        )
        self.parent.widgets.trash_btn.grid(
            column=2, row=0, pady=10, padx=(0, 10), sticky="e"
        )
        self.parent.widgets.download_button.grid(
            column=3, row=0, padx=(0, 20), pady=(10, 10), sticky="e"
        )
        self.parent.widgets.options.grid(
            column=1, row=0, padx=10, pady=(10, 10), sticky="w"
        )
